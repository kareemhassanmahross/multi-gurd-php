                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="code/controller/Auth.php"method="post">
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="phone" type="phone" name="phone" placeholder="phone" />
                                            ...
                                            <div class=" mb-4">
                                                        ...
                                                        <input class="form-control" id="image" type="file" name="image" placeholder="Confirm password" />
                                                    </div>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
